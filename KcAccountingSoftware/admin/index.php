...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="nav-item"><a class="nav-link" href="index.php?page=add-student"><i class="fa fa-user-plus"></i> Add Client</a></li>
      <li class="nav-item"><a class="nav-link" href="index.php?page=add-user"><i class="fa fa-user"></i> Add User</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="index.php?page=add-student" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Add Company</a>
              <a href="index.php?page=all-student" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> All Companys</a>
              <a href="index.php?page=add-employees" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Add Employees</a>
...
<!--     <footer >
      ...
      <p>Odin Software Solutions &copy; 2016 to <?php echo date('Y') ?></p>
      </div>
    </footer> -->
    </div>
